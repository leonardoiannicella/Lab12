...
public class RiversController {
    ...
    void doSimula(ActionEvent event) {
    	try {
    		...
    		txtResult.setText(model.simula(k));
    ...
    void doTendina(ActionEvent event) {
    	...
    	FiumeResult fr = model.getDatiFiume(river);
    	txtStartDate.setText(fr.getDataPrima().toString());
    	txtEndDate.setText(fr.getDataUltima().toString());
    	txtNumMeasurements.setText(Integer.toString(fr.getMisurazioni()));
    	txtFMed.setText(Float.toString(fr.getMedia()));
